...
from paddle_geometric.datasets import ExplainerDataset
from paddle_geometric.datasets.graph_generator import BAGraph
from paddle_geometric.datasets.motif_generator import HouseMotif
...
def test_explainer_dataset_ba_house(graph_generator, motif_generator):
    ...
    assert data.node_mask.shape== (data.num_nodes, )
    assert data.edge_mask.shape== (data.num_edges, )
