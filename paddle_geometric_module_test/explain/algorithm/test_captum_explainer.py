...
from paddle_geometric.explain.algorithm import CaptumExplainer
...
class GCN(paddle.nn.Layer):
    def __init__(self, model_config: ModelConfig):
        ...
        self.param = paddle.nn.Parameter(paddle.empty(1))
...
def test_captum_explainer_binary_classification(
    ...
    edge_label_index = paddle.to_tensor([[0, 1, 2], [2, 3, 1]])
...
@pytest.mark.parametrize('index', [1, paddle.arange(2)])
