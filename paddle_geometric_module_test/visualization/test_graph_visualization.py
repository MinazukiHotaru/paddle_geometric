...
from paddle_geometric.testing import onlyGraphviz, withPackage
from paddle_geometric.visualization import visualize_graph
...
def test_visualize_graph_via_graphviz(tmp_path, backend):
    ...
    edge_weight = (paddle.rand([edge_index.shape[1]]) > 0.5).astype('float32')
