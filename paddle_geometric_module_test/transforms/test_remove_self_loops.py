...
from paddle_geometric.transforms import RemoveSelfLoops
...
def test_remove_self_loops():
    ...
    edge_index = paddle.to_tensor([[0, 1, 1, 2], [0, 0, 1, 1]])
    edge_weight = paddle.to_tensor([1, 2, 3, 4])
    edge_attr = paddle.to_tensor([[1, 2], [3, 4], [5, 6], [7, 8]])
