...
from paddle_geometric.loader import DataListLoader, DataLoader, DenseDataLoader
from paddle_geometric.testing import onlyOnline
from paddle_geometric.transforms import ToDense
...
def test_enzymes(get_dataset):
    ...
    assert len(dataset[paddle.arange(100, dtype=paddle.int64)]) == 100
    mask = paddle.zeros(600, dtype=paddle.bool)
    mask[:100] = 1
