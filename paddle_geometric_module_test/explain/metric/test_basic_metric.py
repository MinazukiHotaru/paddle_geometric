...
def test_perfect_groundtruth_metrics():
    pred_mask = target_mask = paddle.rand(10)
...
def test_groundtruth_true_negative():
    ...
    pred_mask = target_mask = paddle.zeros(10)
