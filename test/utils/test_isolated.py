...
def test_remove_isolated_nodes():
    ...
    # if is_full_test():
    #     jit = paddle.jit.script(remove_isolated_nodes)
    ...
    edge_index = paddle.tensor([[0, 2, 1, 0, 2], [2, 0, 1, 0, 2]])
    edge_attr = paddle.tensor([1, 2, 3, 4, 5])
