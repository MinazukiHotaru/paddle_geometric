...
from paddle_geometric.nn.aggr.base import Aggregation
from paddle_geometric.nn.aggr.basic import (
    MaxAggregation,
    MeanAggregation,
    MinAggregation,
    MulAggregation,
...
class FusedAggregation(Aggregation):
    ...
    Used internally in :class:`~paddle_geometric.nn.aggr.MultiAggregation` to
    ...
    * :class:`StdAggregation` will share the output with either
    ...
    Benchmarking results (summed over 1000 runs):
